...
public class Controller {
	 ...
	 * 2015年2月3日  林进铨
	 * 增加CodeUpdateDT字段 ：
	 * 用于判断中控下的设备是否有IRCode更新
	 * 从而APP判断是否重新请求获取中控下的设备信息
	 */
	Hashtable<String, SubController> subControllers = new Hashtable<>();
	
	private long codeUpdateDT=0;
	
	public long getCodeUpdateDT() {
		return codeUpdateDT;
	}

	public void setCodeUpdateDT(long codeUpdateDT) {
		this.codeUpdateDT = codeUpdateDT;
	}
	...
	public boolean isOnline() {
		return System.currentTimeMillis() - getLastHeartbeatDT() <= 1 * 60 * 1000;
	}
	...
	public static byte[] convertControllerId2Bytes(String controllerId) {
		...
		System.out.println(controllerId+"   "+controllerId.length());
